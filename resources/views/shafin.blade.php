        ...
        <div class="row">
          <div class="col-xl-6 col-lg-6">
            <div class="tf__common_heading tf__common_heading2">
              <h6>home /  Shafin Haider</h6>
              <h2 class="tf__common_heading_color">
              Shafin Haider
              </h2>
              <h3>
                  In-charge, Production (Chattogram Division)
              </h3><br>
              <h3>
             
</h3>
              <p>
              Shafin Haider is currently working in Our Canvas as an
In-charge of Production for the Chattogram Division
